...
function calcSetColorsByAttribute() {
  var z, i, att;
  z = document.getElementsByTagName("*");
  for (i = 0; i < z.length; i++) {
    att = z[i].getAttribute("data-calc-color");
    if (att) {
      z[i].style.backgroundColor = calccolor(att).toRgbString();
    }
  }
}
